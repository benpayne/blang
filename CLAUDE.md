...
- **Active epics**:
  ...
  - `modules-v2-exports` (`docs/epics/modules-v2-exports/`) — status:
    **U1 complete** (construction ABI: library-emitted factory; see
    `specs/029-construction-abi-factory/spike.md`), U2-U5 pending.
